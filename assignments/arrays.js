...
// console.log(inventory[49]['car_year'])
...
let firstCar = inventory[32];
// console.log(firstCar);
console.log(`Car 33 is a ${firstCar.car_year} ${firstCar.car_make} ${firstCar.car_model}`);
...
let carYears = inventory.map(caryear => caryear.car_year);
console.log(carYears);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
let oldCars = carYears.filter(function(oldcar) {
  return oldcar < 2000;
});
// console.log(oldCars);
...
let BMWAndAudi = inventory.filter(baa => baa.car_make === "Audi" || baa.car_make === 'BMW');
